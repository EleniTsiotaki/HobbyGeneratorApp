...
namespace HobbyGeneratorAPI.Migrations
{
    ...
    [Migration("20250604135252_AddForumPostsNavigationAndCascade")]
    partial class AddForumPostsNavigationAndCascade
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApplicationUserHobby", b =>
                {
                    b.HasOne("HobbyGeneratorAPI.Models.Hobby", null)
                        .WithMany()
                        .HasForeignKey("HobbiesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HobbyGeneratorAPI.Models.ApplicationUser", null)
                        .WithMany()
